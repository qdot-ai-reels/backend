...
class HyperFramesCaptionTests(unittest.TestCase):
    def test_build_transcript_maps_scene_subtitles_to_caption_cues(self) -> None:
        script = {
            ...
            "product": {"usp": "핵심 장점"},
            "customer": {"main_target": "보호자", "pain_point": "제품 선택이 어려움"},
            "ads": {
                "goal": "상품 소개",
                "cta_action": "상품 확인",
                "channel_platform": "Instagram Reels",
                "ad_planner": {"persona": "광고 기획자"},
                "speaker": {"persona": "화자", "tone": "친절한 말투"},
            },
            "video": {"video_duration": "8초", "required_scenes_elements": None, "forbidden_scenes_elements": None},
